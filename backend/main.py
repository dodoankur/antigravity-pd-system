...
async def measure_pd(
    ...
    Args:
        ...
        reference_type: Type of reference object for calibration:
            - "none": Use iris estimation method
            - "credit_card": Standard credit/debit card
            - "coin_gbp_1p" through "coin_gbp_2": GBP coins
            - "ruler": Ruler with 10mm segments
    
    Returns:
        PDMeasurementResult with overall PD, left PD, right PD, and error margins
    """
    # Validate image type
